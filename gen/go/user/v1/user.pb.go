...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2\xc8\x01\n" +
	"\vUserService\x12X\n" +
	...
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponse\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*\"\r/api/v1/usersBAZ?github.com/ChinawatDc/go-api-grpc-gateway/gen/go/user/v1;userv1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	3, // 3: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserRequest
	2, // 4: user.v1.UserService.GetUser:output_type -> user.v1.GetUserResponse
	4, // 5: user.v1.UserService.CreateUser:output_type -> user.v1.CreateUserResponse
